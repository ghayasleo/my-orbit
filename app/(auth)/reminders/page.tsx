...
import { CRUD, remindersBreadcrumb, remindersPage } from "@/constants/pages";
import { DataTable } from "@/components/data-table";
import { reminderColumns } from "@/constants/columns";
          ...
          {!isLoading && filteredReminders.length === 0 && (
            <div className="text-center py-12">
              <div className="text-muted-foreground">
                {searchTerm ? "No reminders found matching your search." : "No reminders yet."}
              </div>
              {!searchTerm && (
